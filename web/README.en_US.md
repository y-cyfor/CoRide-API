...
[![github stars](https://img.shields.io/github/stars/honghuangdc/soybean-admin)](https://github.com/cyfor/coride-api)
[![github forks](https://img.shields.io/github/forks/honghuangdc/soybean-admin)](https://github.com/cyfor/coride-api)
[![gitee stars](https://gitee.com/honghuangdc/soybean-admin/badge/star.svg)](https://gitee.com/honghuangdc/soybean-admin)
[![gitcode star](https://gitcode.com/cyfor/coride-api/star/badge.svg)](https://gitcode.com/cyfor/coride-api)
...
> [!NOTE]
> If you think `CoRide-API Admin` is helpful to you, or you like our project, please give us a ⭐️ on GitHub. Your support is the driving force for us to continue to improve and add new features! Thank you for your support!

> [!NOTE]
> The `CoRide-API Admin` quick start series videos have been uploaded to [Bilibili](https://www.bilibili.com/video/BV1YKdRYXELC) Go online [click here](https://www.bilibili.com/video/BV1YKdRYXELC) Go check it out

## Introduction

[`CoRide-API Admin`](https://github.com/cyfor/coride-api) is a clean, elegant, beautiful and powerful admin template, based on the latest front-end technology stack, including Vue3, Vite7, TypeScript, Pinia and UnoCSS. It has built-in rich theme configuration and components, strict code specifications, and an automated file routing system. In addition, it also uses the online mock data solution based on ApiFox. `CoRide-API Admin` provides you with a one-stop admin solution, no additional configuration, and out of the box. It is also a best practice for learning cutting-edge technologies quickly.
...
- **NaiveUI Version:**
  ...
  - [Github Repository](https://github.com/cyfor/coride-api)
  - [Gitee Repository](https://gitee.com/honghuangdc/soybean-admin)
  - [Gitcode Repository](https://gitcode.com/cyfor/coride-api)

- **AntDesignVue Version:**
  - [Preview Link](https://antd.soybeanjs.cn/)
  - [Github Repository](https://github.com/cyfor/coride-api-antd)
  - [Gitee Repository](https://gitee.com/honghuangdc/soybean-admin-antd)
  - [Gitcode Repository](https://gitcode.com/cyfor/coride-api-antd)

- **ElementPlus Version:**
  - [Preview Link](https://elp.soybeanjs.cn/)
  - [Github Repository](https://github.com/cyfor/coride-api-element-plus)
  - [Gitee Repository](https://gitee.com/honghuangdc/soybean-admin-element-plus)
  - [Gitcode Repository](https://gitcode.com/cyfor/coride-api-element-plus)

- **Legacy Version:**
  - [Preview Link](https://legacy.soybeanjs.cn/)
  - [Github Repository](https://github.com/cyfor/coride-api/tree/legacy)
  - [Gitee Repository](https://gitee.com/honghuangdc/soybean-admin/tree/legacy)
  - [Gitcode Repository](https://gitcode.com/cyfor/coride-api/tree/legacy)
...
# gitcode
git clone https://gitcode.com/cyfor/coride-api.git
```
...
- [skyroc-admin](https://github.com/Ohh-889/skyroc-admin): CoRide-API Admin's React version implementation.
...
- [PanisAdmin](https://github.com/paynezhuang/panis-admin): Adopting SpringBoot 3, SaToken, MySQL and other frameworks to develop and modify [soybean-admin](https://github.com/cyfor/coride-api) for the second time, adapting dynamic menu/button-level authorization. Retaining the original flavor, fresh and elegant, high-value back-end management system scaffold.
...
We warmly welcome and appreciate all forms of contributions. If you have any ideas or suggestions, please feel free to share them by submitting [pull requests](https://github.com/cyfor/coride-api/pulls) or creating GitHub [issue](https://github.com/cyfor/coride-api/issues/new).
...
<a href="https://github.com/cyfor/coride-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=cyfor/coride-api" />
</a>
...
<a href="https://openomy.com/cyfor/coride-api" target="_blank" style="display: block; width: 100%;" align="center">
  <img src="https://www.openomy.com/svg?repo=cyfor/coride-api&chart=list&latestMonth=12" target="_blank" alt="Contribution Leaderboard" style="display: block; width: 100%;" />
</a>

## Communication

`CoRide-API Admin` is a completely open source and free project, helping developers to develop medium and large-scale management systems more conveniently. It also provides WeChat and QQ communication groups. If you have any questions, please feel free to ask in the group.
...
[![Star History Chart](https://api.star-history.com/svg?repos=cyfor/coride-api&type=Date)](https://star-history.com/#cyfor/coride-api&Date)
